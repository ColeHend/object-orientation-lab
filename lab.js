...
let favoriteThings = {
  ...
  food:"steak",
  person:"myself",
  book:"Free the darkness by Kel kade",
  movie:"disney hercules",
  holiday:"christmas"
}
...
favoriteThings.car = "13 vw jetta"
...
let myCat = new Cat("Jeff",4,"black")
...
let harry = new Wizard("Harry",17,"fireball")
harry.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
let samsungPhone = new Phone("Samsung","Galaxy S7",16,"Black",230)
let applePhone = new Phone("Apple","Iphone 6",16,"White",300)
let nokiaPhone = new Phone("Nokia","K6",8,"Grey",10)
/* 
...
applePhone.changePrice(200)
console.log(applePhone.price);
...
class Vehicle {
  ...
  move(miles){this.mileage += miles;console.log("Mileage:",this.mileage);}
}
/*
  Create a vehicle using your new class and save it to a variable called myFirstVehicle
*/

let myFirstVehicle = new Vehicle(5,"grey",150000)
...
let myFirstMotorcycle = new Motorcycle(2,"Red",25000,"Honda",true)
...
let myFirstBoat = new Boat(8,"White",5000,"The Boat","Yacht",false)
